namespace MapCreator
{
    ...
    public partial class WonderdraftUserFolderImportDlg : Form
    {
        ...
        public WonderdraftUserFolderImportDlg()
        {
            InitializeComponent();
        }
        ...
        private void CheckAllCheckbox_CheckStateChanged(object sender, EventArgs e)
        {
            if (CheckAllCheckbox.Checked)
            {
                for (int i = 0; i < CollectionListBox.Items.Count; i++)
                {
                    CollectionListBox.SetItemChecked(i, true);
                }
            }
            else
            {
                for (int i = 0; i < CollectionListBox.Items.Count; i++)
                {
                    CollectionListBox.SetItemChecked(i, false);
                }
            }
        }
